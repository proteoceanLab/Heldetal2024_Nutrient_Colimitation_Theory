...
def main():
     ...
     lim_sim_liebig_monod = pandas.read_csv("./Data/Yield_sim_liebig_monod_noiseless_lim_coeffs.csv", index_col=False)
     lim_sim_gm = pandas.read_csv("./Data/Yield_sim_pat_noiseless_lim_coeffs.csv", index_col=False)
     ...
     R1_mesh_sim, R2_mesh_sim, yield_mesh_sim  = colimitation_data_analysis.Read2DScan(f"./Data/Yield_sim_liebig_monod.csv", R1_label, R2_label, yield_labels, num_R1_values, num_R2_values) 
     lim_sim = colimitation_data_analysis.CalculateVirtualSupplementations(R1_mesh_sim, R2_mesh_sim, yield_mesh_sim[:, :, example_sim])
...
################################################################################
     ...
     axis.set_xlabel("Number yield-limiting resources $M_\mathrm{eff}^\mathrm{yield}$", fontsize=colimitation_plots.axis_label_size)
     ...
     figure.savefig("Figure_S24.pdf", bbox_inches="tight")
